                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="posttitle" placeholder="Enter title" value="{{$post->title}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug" class="form-control" id="postslug" placeholder="Enter slug" value="{{$post->slug}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="card card-outline card-info">
                            ...
                            <div class="card-body pad">
                                <div class="mb-3">
                                    <textarea class="textarea" name="body" placeholder="Place some text here" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> {{$post->body}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            <input type="checkbox" name="status" class="form-check-input" id="statuscheck" @if($post->status == 1) checked @endif>
